...
(define-abbrev-table 'global-abbrev-table
  '(
    ...
    ("fafn" "fg_add_function_node" nil :count 1)
    ("favn" "fg_add_variable_node" nil :count 2)
    ("fe" "fg_empty" nil :count 1)
    ...
    ("rsp" "rsp" nil :count 7)
    ("rst" "rpt strip_tac" nil :count 266)
...
(define-abbrev-table 'holscript-mode-abbrev-table
  '(
    ("qgat" "qmatch_goalsub_abbrev_tac" nil :count 89)
   ))
