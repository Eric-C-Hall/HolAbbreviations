...
(define-abbrev-table 'global-abbrev-table
  '(
    ...
    ("dpur" "DEP_PURE_ONCE_REWRITE_TAC" nil :count 226)
    ...
    ("pur" "PURE_REWRITE_TAC" nil :count 160)
    ("puro" "PURE_ONCE_REWRITE_TAC" nil :count 26)
    ("qaat" "qmatch_asmsub_abbrev_tac" nil :count 39)
    ("qat" "qmatch_abbrev_tac" nil :count 16)
    ("qst" "qspecl_then" nil :count 2)
    ("qxa" "qpat_x_assum" nil :count 26)
    ("rbd" "rbd" nil :count 3)
    ...
    ("rsp" "rsp" nil :count 7)
    ("rst" "rpt strip_tac" nil :count 406)
