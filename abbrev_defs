...
(define-abbrev-table 'global-abbrev-table
  '(
    ...
    ("dpur" "DEP_PURE_ONCE_REWRITE_TAC" nil :count 197)
    ("dt" "disch_tac" nil :count 1)
    ("ebps" "ecc_bsc_prob_space" nil :count 203)
    ("eibtv" "event_input_bit_takes_value" nil :count 22)
    ("eissw" "event_input_string_starts_with" nil :count 11)
    ...
    ("erbtv" "event_received_bit_takes_value" nil :count 8)
    ("erpe" "encode_recursive_parity_equation" nil :count 16)
    ...
    ("erpessq" "encode_recursive_parity_equation_state_sequence" nil :count 15)
    ...
    ("esbtv" "event_sent_bit_takes_value" nil :count 18)
    ("esitv" "event_single_input_takes_value" nil :count 3)
    ("esm" "example_state_machine" nil :count 5)
    ("espbtv" "event_srcc_parity_bit_takes_value" nil :count 4)
    ...
    ("esssw" "event_sent_string_starts_with" nil :count 18)
    ...
    ("lnc" "length_n_codes" nil :count 52)
    ("lncups" "length_n_codes_uniform_prob_space" nil :count 22)
    ...
    ("msov2" "mdr_summed_out_values_2" nil :count 8)
    ("msovc" "mdr_summed_out_values_complete" nil :count 17)
    ("mt" "metis_tac" nil :count 26)
    ...
    ("snps" "sym_noise_prob_space" nil :count 27)
    ("st" "strip_tac" nil :count 1)
    ("stti" "states_to_transition_input" nil :count 34)
    ("synd" "sym_noise_dist" nil :count 3)
    ...
    ("una" "unabbrev_all_tac" nil :count 147)
