...
(define-abbrev-table 'global-abbrev-table
  '(
    ...
    ("erssw" "event_received_string_starts_with" nil :count 8)
    ...
    ("esssw" "event_sent_string_starts_with" nil :count 31)
    ...
    ("pur" "PURE_REWRITE_TAC" nil :count 147)
    ("puro" "PURE_ONCE_REWRITE_TAC" nil :count 11)
    ("qaat" "qmatch_asmsub_abbrev_tac" nil :count 34)
    ("qat" "qmatch_abbrev_tac" nil :count 5)
    ("qst" "qspecl_then" nil :count 1)
    ("qxa" "qpat_x_assum" nil :count 14)
...
(define-abbrev-table 'holscript-mode-abbrev-table
  '(
    ("qgat" "qmatch_goalsub_abbrev_tac" nil :count 169)
   ))
