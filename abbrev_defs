...
(define-abbrev-table 'global-abbrev-table
  '(
    ...
    ("ebps" "ecc_bsc_prob_space" nil :count 206)
    ("eibtv" "event_input_bit_takes_value" nil :count 24)
    ("eisp" "event_input_state_parity" nil :count 4)
    ("eissw" "event_input_string_starts_with" nil :count 14)
    ...
    ("erbtv" "event_received_bit_takes_value" nil :count 12)
    ...
    ("erpews" "encode_recursive_parity_equation_with_systematic" nil :count 8)
    ...
    ("esbtv" "event_sent_bit_takes_value" nil :count 22)
    ...
    ("espssw" "event_srcc_parity_string_starts_with" nil :count 3)
    ...
    ("esssw" "event_sent_string_starts_with" nil :count 37)
    ...
    ("ispv" "input_state_parity_valid" nil :count 1)
    ...
    ("msov2" "mdr_summed_out_values_2" nil :count 11)
    ("msovc" "mdr_summed_out_values_complete" nil :count 17)
    ("mt" "metis_tac" nil :count 42)
...
(define-abbrev-table 'holscript-mode-abbrev-table
  '(
    ("qgat" "qmatch_goalsub_abbrev_tac" nil :count 172)
   ))
