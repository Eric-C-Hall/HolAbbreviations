...
(define-abbrev-table 'global-abbrev-table
  '(
    ...
    ("fafn" "fg_add_function_node" nil :count 24)
    ("fafn0" "fg_add_function_node0" nil :count 21)
    ...
    ("funo" "function_nodes" nil :count 25)
    ...
    ("rfg" "rcc_factor_graph" nil :count 6)
    ...
    ("vlm" "variable_length_map" nil :count 3)
    ("vn" "var_nodes" nil :count 9)
