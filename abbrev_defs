...
(define-abbrev-table 'global-abbrev-table
  '(
    ...
    ("adno" "adjacent_nodes" nil :count 30)
    ...
    ("dpur" "DEP_PURE_ONCE_REWRITE_TAC" nil :count 250)
    ...
    ("epi" "extreal_prod_image" nil :count 5)
    ...
    ("esi" "extreal_sum_image" nil :count 25)
    ...
    ("gug" "get_underlying_graph" nil :count 47)
    ...
    ("qat" "qmatch_abbrev_tac" nil :count 24)
    ("qst" "qspecl_then" nil :count 47)
    ("qxa" "qpat_x_assum" nil :count 52)
    ("rbd" "rbd" nil :count 3)
    ...
    ("rsp" "rsp" nil :count 7)
    ("rst" "rpt strip_tac" nil :count 614)
    ...
    ("vm" "val_map" nil :count 16)
    ("vma" "val_map_assignments" nil :count 128)
