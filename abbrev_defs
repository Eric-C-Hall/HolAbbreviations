...
(define-abbrev-table 'global-abbrev-table
  '(
    ...
    ("dpur" "DEP_PURE_ONCE_REWRITE_TAC" nil :count 228)
    ...
    ("pur" "PURE_REWRITE_TAC" nil :count 161)
    ("puro" "PURE_ONCE_REWRITE_TAC" nil :count 27)
    ("qaat" "qmatch_asmsub_abbrev_tac" nil :count 41)
    ("qat" "qmatch_abbrev_tac" nil :count 16)
    ("qst" "qspecl_then" nil :count 4)
    ("qxa" "qpat_x_assum" nil :count 27)
    ("rbd" "rbd" nil :count 3)
    ...
    ("rsp" "rsp" nil :count 7)
    ("rst" "rpt strip_tac" nil :count 428)
